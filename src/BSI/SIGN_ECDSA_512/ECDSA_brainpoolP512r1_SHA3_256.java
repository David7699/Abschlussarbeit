...
public class ECDSA_brainpoolP512r1_SHA3_256 {
	static byte[] input;
	...
	public static void main(String[] args) throws Exception{
		...
		ECGenParameterSpec ecSpec = new ECGenParameterSpec("brainpoolP512r1");
		keyPair = generateECKeyBC(ecSpec);
		prvKey = keyPair.getPrivate();
		pubKey = keyPair.getPublic();
		signature = Signature.getInstance("SHA3-256withECDSA", "BC");
		long start = getTime();
